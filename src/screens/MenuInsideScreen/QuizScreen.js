                    ...
                    <>
                        ...
                        <View >
                            <Text style={{ paddingTop: 10, margin: 10, lineHeight: 18 }}>
                                Depresyon; ciddi, psikolojik, fizyolojik sonuçlara yer açan psikiyatrik bir hastalıktır. Depresyon belirtileri; iştahsızlık, uyku bozulması, günlük aktiviteleri yapamaması, sürekli yorgun ve halsiz hissetme sayılabilir. Depresyonun nedenleri arasında; biyolojik, sosyolojik ve psikolojik durumlar sayılır. Depresyonun farklı türleri vardır: Majör depresyon, Kronik Depresyon, A-tipik Depresyon, Mevsimsel Depresyon’dur. Depresyon tedavisinde; kişi, aile ve tedavi yöntemleri bütüncül olarak önemlidir. Depresyon tedavisinde psikoterapi hizmeti, ilaç tedavisi ve beyin uyarım teknikleri uygulanabilir. Depresyon belirtileri konusunda merak ettikleriniz için Beck Depresyon Testini öneririz. Beck ve arkadaşları (1961) tarafından geliştirilmiş, kişinin depresyon yönünden riskini ve depresif belirtilerin şiddetini değerlendiren 21 maddeden oluşan bir özbildirim ölçeğidir.
